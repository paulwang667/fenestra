...
fn tag_of(n: &Node) -> &'static str {
    match n {
        ...
        Node::Swiper(_) => "swiper",
        Node::Toolbar(_) => "toolbar",
        Node::PageControl(_) => "page_control",
        Node::EmptyState(_) => "empty_state",
        Node::Menubar(_) => "menubar",
        Node::Tree(_) => "tree",
        Node::NavList(_) => "nav_list",
        // Display / feedback
        Node::Badge(_) => "badge",
